...
from control.arm_control import motion, ps4_joystick, raspberry_pi
...
from control.arm_control.interface_classes import (
...
class ArmController(arm_controller_interface.ArmControllerInterface):
    ...
    def visualize_joints(self):
        ...
        anim = FuncAnimation(fig, update, interval=5, fargs=(plotted_elements,))
